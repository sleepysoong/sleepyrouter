...
func candidateIDs(groups ModelGroups, requestedModel, defaultGroup string, groupOrder ...string) []string {
...
func OrderedCandidates(groups ModelGroups, requestedModel, defaultGroup string, groupOrder ...string) []string {
	return append([]string(nil), candidateIDs(groups, requestedModel, defaultGroup, groupOrder...)...)
}

func ChooseModel(groups ModelGroups, requestedModel string, groupOrder ...string) (RouteChoice, error) {
...
func ChooseGroupedModel(groups ModelGroups, requestedModel, defaultGroup string, groupOrder ...string) (RouteChoice, error) {
...
func groupNames(groups ModelGroups, groupOrder ...string) string {
