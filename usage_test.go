...
func TestRunUsageCommand_Aggregated(t *testing.T) {
	...
	defer os.RemoveAll(root)
	store := NewConfigStore(root)
	_ = store.AppendUsage(UsageLogEntry{TS: "2026-06-28T10:00:00Z", Model: "beta", InputTokens: 0, OutputTokens: 0, Success: true})
	_ = store.AppendUsage(UsageLogEntry{TS: "2026-06-28T10:01:00Z", Model: "alpha", InputTokens: 1, OutputTokens: 2, Success: true})
	_ = store.AppendUsage(UsageLogEntry{TS: "2026-06-28T10:02:00Z", Model: "alpha", InputTokens: 0, OutputTokens: 0, Success: false})
