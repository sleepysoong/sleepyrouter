...
| 서피스 | 엔드포인트 | 소스 앵커 | 테스트 |
| --- | --- | --- | --- |
| 헬스체크 | `GET /health` | [server.go](../internal/core/server.go) | `server_test.go` |
| OpenAI 모델 | `GET /v1/models` | [server.go](../internal/core/server.go), [catalog.go](../internal/core/catalog.go) | `server_test.go`, `openrouter_test.go`, `nvidia_test.go` |
| OpenAI 채팅 | `POST /v1/chat/completions` | [server.go](../internal/core/server.go), [sse.go](../internal/core/sse.go) | `server_test.go` |
| Anthropic 메시지 | `POST /anthropic/v1/messages`, `POST /anthropic/messages` | [server.go](../internal/core/server.go), [translate.go](../internal/core/translate.go) | `server_test.go`, `translate_test.go` |
| Anthropic 토큰 카운트 | `POST /anthropic/v1/messages/count_tokens`, `POST /anthropic/messages/count_tokens` | [server.go](../internal/core/server.go) | `server_test.go` |
