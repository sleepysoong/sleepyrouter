...
- Implementation: `openrouter.go`, `nvidia.go`, `copilot.go`, `catalog.go`
- Tests: `catalog_boundary_test.go`, `catalog_test.go`, `copilot_test.go`, and provider-related coverage in `server_test.go`
