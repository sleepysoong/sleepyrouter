...
// WithIncludeReasoningContent enables serializing assistant reasoning_content
// into request messages (required by some endpoints such as the Google Gemini
// OpenAI-compatible surface).
func WithIncludeReasoningContent(v bool) Option {
	return func(o *options) { o.includeReasoningContent = v }
}
...
func Chat(modelID string, opts ...Option) provider.LanguageModel {
	...
	return openaicompat.NewChatModel(openaicompat.ChatModelConfig{
		...
		IncludeReasoningContent: o.includeReasoningContent,
